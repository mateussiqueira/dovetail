...
What is proven on one machine: **1469 testes Dart declarados, 45 pulados** —
...
| `toolkit/dovetail_cli` | 543 Dart | the pipeline, end to end, against a local host with a private CA |
| `toolkit/dovetail_bundler` | 314 Dart | every artefact format, read back by its own header |
