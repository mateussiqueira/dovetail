...
What is proven on one machine: **1404 testes Dart declarados, 45 pulados** —
...
| `toolkit/dovetail_cli` | 500 Dart | the pipeline, end to end, against a local host with a private CA |
