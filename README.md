...
What is proven on one machine: **1424 testes Dart declarados, 45 pulados** —
...
| `toolkit/dovetail_cli` | 513 Dart | the pipeline, end to end, against a local host with a private CA |
| `toolkit/dovetail_bundler` | 299 Dart | every artefact format, read back by its own header |
