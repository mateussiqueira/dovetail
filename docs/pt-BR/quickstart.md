**Português** · [English](../quickstart.md)
...
Se você só quer o runtime num app, é isto:
...
O resto deste documento é a rota do canal assinado, que entrega um binário AOT
autocontido e um SDK versionado no disco.
...
em vez de adivinhar. Até que exista, o caminho real é o pub.dev ou o monorepo; o que segue
